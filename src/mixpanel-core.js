...
import { addOptOutCheckMixpanelLib, addOptOutCheckMixpanelPeople, clearOptInOut, hasOptedIn, hasOptedOut, optIn, optOut } from './gdpr-utils';
import { MixpanelGroup } from './mixpanel-group';
import { console, document, userAgent, window, _ } from './utils';
...
MixpanelLib.prototype._send_request = function (url, data, callback) {
  ...
  if (!window.navigator.onLine) return url;
...
MixpanelLib.prototype.track = addOptOutCheckMixpanelLib(function (event_name, properties, callback) {
  ...
  var send_result = this._send_request(
    preURL,
    preData,
